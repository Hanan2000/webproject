...
if (isset($_COOKIE['username'])) {
    ...
    <?php
    if(isset($_POST['edit'])) {
        if (isset($_POST['pwd']) && isset($_POST['email']) && isset($_POST['fname']) && isset($_POST['lname'])) {
            $email = $_POST['email'];
            $password = $_POST['pwd'];
            $fname = $_POST['fname'];
            $lname = $_POST['lname'];
        ...
        try {
            $db = new mysqli('localhost', 'root', '', 'sugarbloom');
            $qrystr = "UPDATE user SET email = '$email', password = '$password', first_name ='$fname' , last_name='$lname' WHERE username='$username';";
            $db->query($qrystr);
            $db->commit();
            $db->close();
        } catch (Exception $e) {
                ...
                <div class="col-lg-12 login-form">
                    <form action="account.php" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="FN" value=" <?php echo $row['first_name'];?>" name="fname" >
                        </div>
                        <div class="form-group">
                            <label class="form-control-label">LAST NAME</label>
                            <input type="text" class="form-control"  id="LN" value=" <?php echo $row['last_name']; ?>" name="lname"  >
                        </div>

                        <div class="form-group">
                            <label class="form-control-label"> Email </label>
                            <input type="text" class="form-control" id="E" value=" <?php echo $row['email']; ?>" name="email" >
                        </div>
                        <!--                        <div class="form-group">-->
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="P" value=" <?php echo  $row['password']; ?>" name="pwd">
                        </div>
