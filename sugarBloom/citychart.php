...
<head>
    ...
    if (isset($_POST['Show'])&&(isset($_POST['City']))) {

        $city = $_POST['City'];

        $db=new mysqli('localhost','root','','sugarbloom');
        $qrystr="SELECT `order_id`, `total` FROM `orders` WHERE city='$city'";
        $res=$db->query($qrystr);
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-8 login-box">
            ...
            <div class="col-lg-12 login-form">
                <div class="col-lg-12 login-form">
                    <form action="citychart.php" method="post">
                        <div class="form-group">
                            <label class="form-control-label" >Enter the city to see the percent of orders in it </label>
                            <input type="text" class="form-control" name="City" required="required" placeholder="Nablus">
                        </div>
...
<div style="width: 1000px;height: 1000px;display: inline-flex" >
...
<script>
    ...
    var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: <?php  echo json_encode($order_id); ?>,
            datasets: [{
                label: 'Total price of all orders in this  City',
